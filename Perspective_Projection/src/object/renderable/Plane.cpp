...
Plane::Plane(sf::Vector3f position, sf::Vector2f size, sf::RenderTarget* target, std::string name, sf::Color color)
{
	isTextured = false;
	name_ = name;
	this->target = target;
...
Plane::Plane(sf::Vector3f position, sf::Vector2f size, sf::RenderTarget* target, std::string name, Texture* texture)
{
	isTextured = true;
	name_ = name;
	this->target = target;
...
void Plane::connect(sf::RenderTarget* target)
{
