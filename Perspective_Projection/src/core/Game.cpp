...
void projection::Game::initGameObjects()
{
...
void projection::Game::updateGameObjects()
{/*
...
void projection::Game::updateGUI()
{
    GUI_->menuBar();
    GUI_->objectBrowser();
